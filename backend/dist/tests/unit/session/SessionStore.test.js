...
describe('SessionStore', () => {
    ...
    it('同名会话会以最新 session 覆盖名称索引', () => {
        const store = new SessionStore();
        store.createSession({ sessionId: 's-1', playerName: 'Steve', socketId: 'socket-1', connectedAt: 100 });
        store.createSession({ sessionId: 's-2', playerName: 'Steve', socketId: 'socket-2', connectedAt: 200 });
