...
import type { ClientSession, SessionStore } from '../../domain/session/SessionStore.js';
...
export function handleClientJoin(input: ClientJoinInput, deps: ClientJoinDeps): ClientSession | null {
